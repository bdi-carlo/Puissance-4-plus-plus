...
void afficher_regles(){
	...
	printf("	- Pour gagner la partie il suffit d'aligner 4 pions de sa couleur \n");
	printf("	- Le joueur a à sa disposition 3 types de pièces : Bloquantes, Creuses et Pleines \n");
	printf("		Une pièce creuse peut passer au dessus d’une pièce pleine (ou s’arrêter dessus) \n");
	printf("		une pièce pleine peut passer au travers d’une pièce creuse (ou s’arrêter dessus) \n");
	printf("		Deux pièces de même type ne peuvent pas se traverser \n");
	printf("		Une pièce bloquante ne peut être traversée ni par une pièce creuse ni par une pièce pleine. \n");
	printf("		Les joueurs n’ont droit qu’à 2 pièces bloquantes durant une partie \n");
	printf("\n \n Tapez 1 si vous avez compris les regles et voulez passer au jeu"); 
	scanf("%i",&regles);
